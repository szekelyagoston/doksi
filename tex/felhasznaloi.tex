...
\item NFC ki van kapcsolva. Ez esetben bal alsó sarokban található csillagra kattintva a telefon megnyitja a beépített beállításkezelőt, ahol be lehet kapcsolni az NFC-t. A vissza gombra kattintva a folyamat innen tovább folytatható (27. ábra).
\end{itemize}
...
Amennyiben a megadott név szabad, úgy egy új gomb jelenik meg "OPEN APP" felirattal (19. ábra). 
