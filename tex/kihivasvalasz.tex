...
\begin{itemize}
\item arcfelismerő modulja visszaadja a felismert arcokat, és egy téglalapot illeszt rájuk.
\item visszadja többek között a szemek, pupillák, orr pozícióját.
\item életkort és nemet tippel.
\item visszaadja a fej pozícióit (elfordulás). Ami nekünk itt fontos, az a "yaw" tulajdonság értéke. Ez adja meg hogy merre fordul a felismert arc.
\item a felsmerhető érzelmekre ad egy százalékos valószínűséget (megleptés, harag, stb.)
\item arcösszehasonlító modulja pedig két arcról megállapítja, hogy mekkora valószínűséggel tartoznak ugyanahhoz a fizikai személyhez
\end{itemize}
\begin{figure}[h]
\centering
